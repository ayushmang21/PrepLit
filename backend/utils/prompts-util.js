...
2. Include a "priority" field with exactly one of these values: "High", "Medium", or "Low".
3. Set priority based on interview importance:
   - High: core concepts that are very likely to be asked
   - Medium: useful but not always central topics
   - Low: edge cases, advanced extras, or less frequent topics
